...
- [Testing Guidelines](../docs/testing-guidelines.md) - Testing standards and practices for the application
- [Coding Guidelines](../docs/coding-guidelines.md) - Coding standards and quality principles for the application
